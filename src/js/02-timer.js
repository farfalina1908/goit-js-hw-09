...
const options = {
    ...
    onClose(selectedDates) {
      ...
      onChoiseValidDate(selectedDates[0]);
    },
  };

  function onChoiseValidDate (selectedDates) {
  ...
  function startTimer() {
    const dateDifference = choosedDate - Date.now();
    const formatDate = convertMs(dateDifference);
